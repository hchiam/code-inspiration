...
function ShortcutButtonsGroup(props) {
  return (
    <div id="shortcut-buttons-group">
      <button
        onClick={() =>
          props.addSpecialCharacters("const  = () => {\n  \n};", 16)
        }
      ...
      <button
        onClick={() => props.addSpecialCharacters("()")}
      ...
      <button
        onClick={() => props.addSpecialCharacters("// ", 0)}
      ...
      <button
        ...
        style={{
          display: props.suggestion.suggestion ? "inline-block" : "none",
        }}
